...
module "default" {
  ...
  cluster_endpoint_private_connection_prefix = "polardbmysqlprivateprefix${random_integer.default.result}"
  cluster_endpoint_private_port              = "5432"
  cluster_endpoint_description               = var.cluster_endpoint_description
  ...
  cluster_endpoint_public_connection_prefix = "polardbmysqlpublicprefix${random_integer.default.result}"
